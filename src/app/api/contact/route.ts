...
const requiredFields = ["Nombre", "Email", "Tipo de consulta", "Asunto", "Mensaje"];
...
export async function POST(request: Request) {
  ...
  try {
    ...
    formData.set("subject", "Nuevo contacto desde JellySolutions");
    formData.set("from_name", "JellySolutions - Contacto");
